...
// Sensor Kinematics 
    ...
    OPcp0_18 = OPcp0_16+ROcp0_46*qdd[7]+ROcp0_46*qdd[8]+qd[7]*(OMcp0_26*ROcp0_66-OMcp0_36*ROcp0_56)+qd[8]*(OMcp0_27*
 ROcp0_66-OMcp0_37*ROcp0_56);
    OPcp0_28 = OPcp0_26+ROcp0_56*qdd[7]+ROcp0_56*qdd[8]-qd[7]*(OMcp0_16*ROcp0_66-OMcp0_36*ROcp0_46)-qd[8]*(OMcp0_17*
 ROcp0_66-OMcp0_37*ROcp0_46);
    OPcp0_38 = OPcp0_36+ROcp0_66*qdd[7]+ROcp0_66*qdd[8]+qd[7]*(OMcp0_16*ROcp0_56-OMcp0_26*ROcp0_46)+qd[8]*(OMcp0_17*
 ROcp0_56-OMcp0_27*ROcp0_46);
...
// Sensor Kinematics 
    ...
    OPcp1_110 = OPcp1_16+ROcp1_46*qdd[10]+ROcp1_46*qdd[9]+qd[10]*(OMcp1_29*ROcp1_66-OMcp1_39*ROcp1_56)+qd[9]*(OMcp1_26*
 ROcp1_66-OMcp1_36*ROcp1_56);
    OPcp1_210 = OPcp1_26+ROcp1_56*qdd[10]+ROcp1_56*qdd[9]-qd[10]*(OMcp1_19*ROcp1_66-OMcp1_39*ROcp1_46)-qd[9]*(OMcp1_16*
 ROcp1_66-OMcp1_36*ROcp1_46);
    OPcp1_310 = OPcp1_36+ROcp1_66*qdd[10]+ROcp1_66*qdd[9]+qd[10]*(OMcp1_19*ROcp1_56-OMcp1_29*ROcp1_46)+qd[9]*(OMcp1_16*
 ROcp1_56-OMcp1_26*ROcp1_46);
...
// Sensor Kinematics 
    ...
    OPcp2_112 = OPcp2_16+ROcp2_46*qdd[11]+ROcp2_46*qdd[12]+qd[11]*(OMcp2_26*ROcp2_66-OMcp2_36*ROcp2_56)+qd[12]*(OMcp2_211*
 ROcp2_66-OMcp2_311*ROcp2_56);
    OPcp2_212 = OPcp2_26+ROcp2_56*qdd[11]+ROcp2_56*qdd[12]-qd[11]*(OMcp2_16*ROcp2_66-OMcp2_36*ROcp2_46)-qd[12]*(OMcp2_111*
 ROcp2_66-OMcp2_311*ROcp2_46);
    OPcp2_312 = OPcp2_36+ROcp2_66*qdd[11]+ROcp2_66*qdd[12]+qd[11]*(OMcp2_16*ROcp2_56-OMcp2_26*ROcp2_46)+qd[12]*(OMcp2_111*
 ROcp2_56-OMcp2_211*ROcp2_46);
...
// Sensor Kinematics 
    ...
    OPcp3_114 = OPcp3_16+ROcp3_46*qdd[13]+ROcp3_46*qdd[14]+qd[13]*(OMcp3_26*ROcp3_66-OMcp3_36*ROcp3_56)+qd[14]*(OMcp3_213*
 ROcp3_66-OMcp3_313*ROcp3_56);
    OPcp3_214 = OPcp3_26+ROcp3_56*qdd[13]+ROcp3_56*qdd[14]-qd[13]*(OMcp3_16*ROcp3_66-OMcp3_36*ROcp3_46)-qd[14]*(OMcp3_113*
 ROcp3_66-OMcp3_313*ROcp3_46);
    OPcp3_314 = OPcp3_36+ROcp3_66*qdd[13]+ROcp3_66*qdd[14]+qd[13]*(OMcp3_16*ROcp3_56-OMcp3_26*ROcp3_46)+qd[14]*(OMcp3_113*
 ROcp3_56-OMcp3_213*ROcp3_46);
...
// Sensor Kinematics 
    ...
    OPcp4_18 = OPcp4_16+ROcp4_46*qdd[7]+ROcp4_46*qdd[8]+qd[7]*(OMcp4_26*ROcp4_66-OMcp4_36*ROcp4_56)+qd[8]*(OMcp4_27*
 ROcp4_66-OMcp4_37*ROcp4_56);
    OPcp4_28 = OPcp4_26+ROcp4_56*qdd[7]+ROcp4_56*qdd[8]-qd[7]*(OMcp4_16*ROcp4_66-OMcp4_36*ROcp4_46)-qd[8]*(OMcp4_17*
 ROcp4_66-OMcp4_37*ROcp4_46);
    OPcp4_38 = OPcp4_36+ROcp4_66*qdd[7]+ROcp4_66*qdd[8]+qd[7]*(OMcp4_16*ROcp4_56-OMcp4_26*ROcp4_46)+qd[8]*(OMcp4_17*
 ROcp4_56-OMcp4_27*ROcp4_46);
...
// Sensor Kinematics 
    ...
    OPcp5_110 = OPcp5_16+ROcp5_46*qdd[10]+ROcp5_46*qdd[9]+qd[10]*(OMcp5_29*ROcp5_66-OMcp5_39*ROcp5_56)+qd[9]*(OMcp5_26*
 ROcp5_66-OMcp5_36*ROcp5_56);
    OPcp5_210 = OPcp5_26+ROcp5_56*qdd[10]+ROcp5_56*qdd[9]-qd[10]*(OMcp5_19*ROcp5_66-OMcp5_39*ROcp5_46)-qd[9]*(OMcp5_16*
 ROcp5_66-OMcp5_36*ROcp5_46);
    OPcp5_310 = OPcp5_36+ROcp5_66*qdd[10]+ROcp5_66*qdd[9]+qd[10]*(OMcp5_19*ROcp5_56-OMcp5_29*ROcp5_46)+qd[9]*(OMcp5_16*
...
// Sensor Kinematics 
    ...
    OPcp6_112 = OPcp6_16+ROcp6_46*qdd[11]+ROcp6_46*qdd[12]+qd[11]*(OMcp6_26*ROcp6_66-OMcp6_36*ROcp6_56)+qd[12]*(OMcp6_211*
 ROcp6_66-OMcp6_311*ROcp6_56);
    OPcp6_212 = OPcp6_26+ROcp6_56*qdd[11]+ROcp6_56*qdd[12]-qd[11]*(OMcp6_16*ROcp6_66-OMcp6_36*ROcp6_46)-qd[12]*(OMcp6_111*
 ROcp6_66-OMcp6_311*ROcp6_46);
    OPcp6_312 = OPcp6_36+ROcp6_66*qdd[11]+ROcp6_66*qdd[12]+qd[11]*(OMcp6_16*ROcp6_56-OMcp6_26*ROcp6_46)+qd[12]*(OMcp6_111*
 ROcp6_56-OMcp6_211*ROcp6_46);
...
// Sensor Kinematics 
    ...
    OPcp7_114 = OPcp7_16+ROcp7_46*qdd[13]+ROcp7_46*qdd[14]+qd[13]*(OMcp7_26*ROcp7_66-OMcp7_36*ROcp7_56)+qd[14]*(OMcp7_213*
 ROcp7_66-OMcp7_313*ROcp7_56);
    OPcp7_214 = OPcp7_26+ROcp7_56*qdd[13]+ROcp7_56*qdd[14]-qd[13]*(OMcp7_16*ROcp7_66-OMcp7_36*ROcp7_46)-qd[14]*(OMcp7_113*
 ROcp7_66-OMcp7_313*ROcp7_46);
    OPcp7_314 = OPcp7_36+ROcp7_66*qdd[13]+ROcp7_66*qdd[14]+qd[13]*(OMcp7_16*ROcp7_56-OMcp7_26*ROcp7_46)+qd[14]*(OMcp7_113*
 ROcp7_56-OMcp7_213*ROcp7_46);
