...
// Backward Dynamics 
  ...
  FA210 = -(s->frc[2][10]-s->m[10]*(AlF26+BS56*s->dpt[2][2]+BeF46*s->dpt[1][2]+BeF66*s->dpt[3][2]+s->l[3][10]*(OM210*
 OM310+C10*(qd[10]*OM39-C9*(OpF16-qd[9]*OM36)+S9*(OpF35+qd[9]*OM16))+S10*(qd[10]*OM19+C9*(OpF35+qd[9]*OM16)+S9*(OpF16-qd[9]*
 OM36)))));
...
// Backward Dynamics 
  ...
  FA212 = -(s->frc[2][12]-s->m[12]*(AlF26+BS56*s->dpt[2][3]+BeF46*s->dpt[1][3]+BeF66*s->dpt[3][3]+s->l[3][12]*(OM212*
 OM312+C12*(qd[12]*OM311-C11*(OpF16-qd[11]*OM36)+S11*(OpF35+qd[11]*OM16))+S12*(qd[12]*OM111+C11*(OpF35+qd[11]*OM16)+S11*(
 OpF16-qd[11]*OM36)))));
  ...
  FB212_4 = -s->m[12]*(OpM16_4*s->dpt[3][3]-s->dpt[1][3]*S5+s->l[3][12]*(C12*(OpM16_4*C11-S11*S5)-S12*(OpM16_4*S11+C11*
 S5)));
...
// Backward Dynamics 
  ...
  FA214 = -(s->frc[2][14]-s->m[14]*(AlF26+BS56*s->dpt[2][4]+BeF46*s->dpt[1][4]+BeF66*s->dpt[3][4]+s->l[3][14]*(OM214*
 OM314+C14*(qd[14]*OM313-C13*(OpF16-qd[13]*OM36)+S13*(OpF35+qd[13]*OM16))+S14*(qd[14]*OM113+C13*(OpF35+qd[13]*OM16)+S13*(
 OpF16-qd[13]*OM36)))));
  ...
  FB214_4 = -s->m[14]*(OpM16_4*s->dpt[3][4]-s->dpt[1][4]*S5+s->l[3][14]*(C14*(OpM16_4*C13-S13*S5)-S14*(OpM16_4*S13+C13*
 S5)));
...
// Backward Dynamics 
  ...
  FF16 = -(s->frc[1][6]-s->m[6]*AlF16-FF11_112*C11-FF11_312*S11-FF13_114*C13-FF13_314*S13-FF7_18*C7-FF7_38*S7-FF9_110*C9
 -FF9_310*S9);
  FF26 = -(s->frc[2][6]-FA210-FA212-FA214-FA28-s->m[6]*AlF26);
  FF36 = -(s->frc[3][6]-s->m[6]*AlF35+FF11_112*S11-FF11_312*C11+FF13_114*S13-FF13_314*C13+FF7_18*S7-FF7_38*C7+FF9_110*S9
 -FF9_310*C9);
  CF16 = -(s->trq[1][6]-s->In[1][6]*OpF16-CF11_112*C11-CF11_312*S11-CF13_114*C13-CF13_314*S13-CF7_18*C7-CF7_38*S7-
 CF9_110*C9-CF9_310*S9+FA210*s->dpt[3][2]+FA212*s->dpt[3][3]+FA214*s->dpt[3][4]+FA28*s->dpt[3][1]+OM26*OM36*(s->In[5][6]-
 s->In[9][6])+s->dpt[2][1]*(FF7_18*S7-FF7_38*C7)+s->dpt[2][2]*(FF9_110*S9-FF9_310*C9)+s->dpt[2][3]*(FF11_112*S11-FF11_312*C11
 )+s->dpt[2][4]*(FF13_114*S13-FF13_314*C13));
  CF26 = -(s->trq[2][6]-CF210-CF212-CF214-CF28-s->In[5][6]*OpF26-OM16*OM36*(s->In[1][6]-s->In[9][6])-s->dpt[1][1]*(
 FF7_18*S7-FF7_38*C7)-s->dpt[1][2]*(FF9_110*S9-FF9_310*C9)-s->dpt[1][3]*(FF11_112*S11-FF11_312*C11)-s->dpt[1][4]*(FF13_114*
 S13-FF13_314*C13)-s->dpt[3][1]*(FF7_18*C7+FF7_38*S7)-s->dpt[3][2]*(FF9_110*C9+FF9_310*S9)-s->dpt[3][3]*(FF11_112*C11+
 FF11_312*S11)-s->dpt[3][4]*(FF13_114*C13+FF13_314*S13));
  CF36 = -(s->trq[3][6]-s->In[9][6]*OpF35+CF11_112*S11-CF11_312*C11+CF13_114*S13-CF13_314*C13+CF7_18*S7-CF7_38*C7+
 CF9_110*S9-CF9_310*C9-FA210*s->dpt[1][2]-FA212*s->dpt[1][3]-FA214*s->dpt[1][4]-FA28*s->dpt[1][1]+OM16*OM26*(s->In[1][6]-
 s->In[5][6])+s->dpt[2][1]*(FF7_18*C7+FF7_38*S7)+s->dpt[2][2]*(FF9_110*C9+FF9_310*S9)+s->dpt[2][3]*(FF11_112*C11+FF11_312*S11
 )+s->dpt[2][4]*(FF13_114*C13+FF13_314*S13));
  FM16_1 = s->m[6]*AlM16_1+FM111_112*C11+FM111_312*S11+FM131_114*C13+FM131_314*S13+FM71_18*C7+FM71_38*S7+FM91_110*C9+
 FM91_310*S9;
  FM26_1 = FB210_1+FB212_1+FB214_1+FB28_1+s->m[6]*AlM26_1;
  FM36_1 = s->m[6]*S5-FM111_112*S11+FM111_312*C11-FM131_114*S13+FM131_314*C13-FM71_18*S7+FM71_38*C7-FM91_110*S9+FM91_310
 *C9;
  CM16_1 = CM111_112*C11+CM111_312*S11+CM131_114*C13+CM131_314*S13+CM71_18*C7+CM71_38*S7+CM91_110*C9+CM91_310*S9-FB210_1
 *s->dpt[3][2]-FB212_1*s->dpt[3][3]-FB214_1*s->dpt[3][4]-FB28_1*s->dpt[3][1]-s->dpt[2][1]*(FM71_18*S7-FM71_38*C7)-
 s->dpt[2][2]*(FM91_110*S9-FM91_310*C9)-s->dpt[2][3]*(FM111_112*S11-FM111_312*C11)-s->dpt[2][4]*(FM131_114*S13-FM131_314*C13);
  CM26_1 = CM210_1+CM212_1+CM214_1+CM28_1+s->dpt[1][1]*(FM71_18*S7-FM71_38*C7)+s->dpt[1][2]*(FM91_110*S9-FM91_310*C9)+
 s->dpt[1][3]*(FM111_112*S11-FM111_312*C11)+s->dpt[1][4]*(FM131_114*S13-FM131_314*C13)+s->dpt[3][1]*(FM71_18*C7+FM71_38*S7)+
 s->dpt[3][2]*(FM91_110*C9+FM91_310*S9)+s->dpt[3][3]*(FM111_112*C11+FM111_312*S11)+s->dpt[3][4]*(FM131_114*C13+FM131_314*S13);
  CM36_1 = -(CM111_112*S11-CM111_312*C11+CM131_114*S13-CM131_314*C13+CM71_18*S7-CM71_38*C7+CM91_110*S9-CM91_310*C9-
 FB210_1*s->dpt[1][2]-FB212_1*s->dpt[1][3]-FB214_1*s->dpt[1][4]-FB28_1*s->dpt[1][1]+s->dpt[2][1]*(FM71_18*C7+FM71_38*S7)+
 s->dpt[2][2]*(FM91_110*C9+FM91_310*S9)+s->dpt[2][3]*(FM111_112*C11+FM111_312*S11)+s->dpt[2][4]*(FM131_114*C13+FM131_314*S13)
 );
  FM16_2 = s->m[6]*AlM16_2+FM112_112*C11+FM112_312*S11+FM132_114*C13+FM132_314*S13+FM72_18*C7+FM72_38*S7+FM92_110*C9+
 FM92_310*S9;
  FM26_2 = FB210_2+FB212_2+FB214_2+FB28_2+s->m[6]*AlM26_2;
  CM16_2 = CM112_112*C11+CM112_312*S11+CM132_114*C13+CM132_314*S13+CM72_18*C7+CM72_38*S7+CM92_110*C9+CM92_310*S9-FB210_2
 *s->dpt[3][2]-FB212_2*s->dpt[3][3]-FB214_2*s->dpt[3][4]-FB28_2*s->dpt[3][1]-s->dpt[2][1]*(FM72_18*S7-FM72_38*C7)-
 s->dpt[2][2]*(FM92_110*S9-FM92_310*C9)-s->dpt[2][3]*(FM112_112*S11-FM112_312*C11)-s->dpt[2][4]*(FM132_114*S13-FM132_314*C13);
  CM26_2 = CM210_2+CM212_2+CM214_2+CM28_2+s->dpt[1][1]*(FM72_18*S7-FM72_38*C7)+s->dpt[1][2]*(FM92_110*S9-FM92_310*C9)+
 s->dpt[1][3]*(FM112_112*S11-FM112_312*C11)+s->dpt[1][4]*(FM132_114*S13-FM132_314*C13)+s->dpt[3][1]*(FM72_18*C7+FM72_38*S7)+
 s->dpt[3][2]*(FM92_110*C9+FM92_310*S9)+s->dpt[3][3]*(FM112_112*C11+FM112_312*S11)+s->dpt[3][4]*(FM132_114*C13+FM132_314*S13);
  CM36_2 = -(CM112_112*S11-CM112_312*C11+CM132_114*S13-CM132_314*C13+CM72_18*S7-CM72_38*C7+CM92_110*S9-CM92_310*C9-
 FB210_2*s->dpt[1][2]-FB212_2*s->dpt[1][3]-FB214_2*s->dpt[1][4]-FB28_2*s->dpt[1][1]+s->dpt[2][1]*(FM72_18*C7+FM72_38*S7)+
 s->dpt[2][2]*(FM92_110*C9+FM92_310*S9)+s->dpt[2][3]*(FM112_112*C11+FM112_312*S11)+s->dpt[2][4]*(FM132_114*C13+FM132_314*S13)
 );
  FM16_3 = s->m[6]*AlM16_3+FM113_112*C11+FM113_312*S11+FM133_114*C13+FM133_314*S13+FM73_18*C7+FM73_38*S7+FM93_110*C9+
 FM93_310*S9;
  FM26_3 = FB210_3+FB212_3+FB214_3+FB28_3+s->m[6]*AlM26_3;
  CM16_3 = CM113_112*C11+CM113_312*S11+CM133_114*C13+CM133_314*S13+CM73_18*C7+CM73_38*S7+CM93_110*C9+CM93_310*S9-FB210_3
 *s->dpt[3][2]-FB212_3*s->dpt[3][3]-FB214_3*s->dpt[3][4]-FB28_3*s->dpt[3][1]-s->dpt[2][1]*(FM73_18*S7-FM73_38*C7)-
 s->dpt[2][2]*(FM93_110*S9-FM93_310*C9)-s->dpt[2][3]*(FM113_112*S11-FM113_312*C11)-s->dpt[2][4]*(FM133_114*S13-FM133_314*C13);
  CM26_3 = CM210_3+CM212_3+CM214_3+CM28_3+s->dpt[1][1]*(FM73_18*S7-FM73_38*C7)+s->dpt[1][2]*(FM93_110*S9-FM93_310*C9)+
 s->dpt[1][3]*(FM113_112*S11-FM113_312*C11)+s->dpt[1][4]*(FM133_114*S13-FM133_314*C13)+s->dpt[3][1]*(FM73_18*C7+FM73_38*S7)+
 s->dpt[3][2]*(FM93_110*C9+FM93_310*S9)+s->dpt[3][3]*(FM113_112*C11+FM113_312*S11)+s->dpt[3][4]*(FM133_114*C13+FM133_314*S13);
  CM36_3 = -(CM113_112*S11-CM113_312*C11+CM133_114*S13-CM133_314*C13+CM73_18*S7-CM73_38*C7+CM93_110*S9-CM93_310*C9-
 FB210_3*s->dpt[1][2]-FB212_3*s->dpt[1][3]-FB214_3*s->dpt[1][4]-FB28_3*s->dpt[1][1]+s->dpt[2][1]*(FM73_18*C7+FM73_38*S7)+
 s->dpt[2][2]*(FM93_110*C9+FM93_310*S9)+s->dpt[2][3]*(FM113_112*C11+FM113_312*S11)+s->dpt[2][4]*(FM133_114*C13+FM133_314*S13)
 );
  CM16_4 = s->In[1][6]*OpM16_4+CM114_112*C11+CM114_312*S11+CM134_114*C13+CM134_314*S13+CM74_18*C7+CM74_38*S7+CM94_110*C9
 +CM94_310*S9-FB210_4*s->dpt[3][2]-FB212_4*s->dpt[3][3]-FB214_4*s->dpt[3][4]-FB28_4*s->dpt[3][1]-s->dpt[2][1]*(FM74_18*S7-
 FM74_38*C7)-s->dpt[2][2]*(FM94_110*S9-FM94_310*C9)-s->dpt[2][3]*(FM114_112*S11-FM114_312*C11)-s->dpt[2][4]*(FM134_114*S13-
 FM134_314*C13);
  CM26_4 = CM210_4+CM212_4+CM214_4+CM28_4+s->In[5][6]*OpM26_4+s->dpt[1][1]*(FM74_18*S7-FM74_38*C7)+s->dpt[1][2]*(
 FM94_110*S9-FM94_310*C9)+s->dpt[1][3]*(FM114_112*S11-FM114_312*C11)+s->dpt[1][4]*(FM134_114*S13-FM134_314*C13)+s->dpt[3][1]*
 (FM74_18*C7+FM74_38*S7)+s->dpt[3][2]*(FM94_110*C9+FM94_310*S9)+s->dpt[3][3]*(FM114_112*C11+FM114_312*S11)+s->dpt[3][4]*(
 FM134_114*C13+FM134_314*S13);
  CM36_4 = s->In[9][6]*S5-CM114_112*S11+CM114_312*C11-CM134_114*S13+CM134_314*C13-CM74_18*S7+CM74_38*C7-CM94_110*S9+
 CM94_310*C9+FB210_4*s->dpt[1][2]+FB212_4*s->dpt[1][3]+FB214_4*s->dpt[1][4]+FB28_4*s->dpt[1][1]-s->dpt[2][1]*(FM74_18*C7+
 FM74_38*S7)-s->dpt[2][2]*(FM94_110*C9+FM94_310*S9)-s->dpt[2][3]*(FM114_112*C11+FM114_312*S11)-s->dpt[2][4]*(FM134_114*C13+
 FM134_314*S13);
  CM36_5 = -(CM115_112*S11-CM115_312*C11+CM135_114*S13-CM135_314*C13+CM75_18*S7-CM75_38*C7+CM95_110*S9-CM95_310*C9-
 FB210_5*s->dpt[1][2]-FB212_5*s->dpt[1][3]-FB214_5*s->dpt[1][4]-FB28_5*s->dpt[1][1]+s->dpt[2][1]*(FM75_18*C7+FM75_38*S7)+
 s->dpt[2][2]*(FM95_110*C9+FM95_310*S9)+s->dpt[2][3]*(FM115_112*C11+FM115_312*S11)+s->dpt[2][4]*(FM135_114*C13+FM135_314*S13)
 );
  CM36_6 = s->In[9][6]+s->m[10]*(s->dpt[1][2]*(s->dpt[1][2]+s->l[3][10]*S10p9)+s->dpt[2][2]*s->dpt[2][2]+s->l[3][10]*
 S10p9*(s->dpt[1][2]+s->l[3][10]*S10p9))+s->m[12]*(s->dpt[1][3]*(s->dpt[1][3]+s->l[3][12]*S11p12)+s->dpt[2][3]*s->dpt[2][3]+
 s->l[3][12]*S11p12*(s->dpt[1][3]+s->l[3][12]*S11p12))+s->m[14]*(s->dpt[1][4]*(s->dpt[1][4]+s->l[3][14]*S13p14)+s->dpt[2][4]*
 s->dpt[2][4]+s->l[3][14]*S13p14*(s->dpt[1][4]+s->l[3][14]*S13p14))+s->m[8]*(s->dpt[1][1]*(s->dpt[1][1]+s->l[3][8]*S7p8)+
 s->dpt[2][1]*s->dpt[2][1]+s->l[3][8]*S7p8*(s->dpt[1][1]+s->l[3][8]*S7p8));
  ...
  CM55_26 = C6*(CM210_5+CM212_5+CM214_5+CM28_5+s->In[5][6]*C6+s->dpt[1][1]*(FM75_18*S7-FM75_38*C7)+s->dpt[1][2]*(
 FM95_110*S9-FM95_310*C9)+s->dpt[1][3]*(FM115_112*S11-FM115_312*C11)+s->dpt[1][4]*(FM135_114*S13-FM135_314*C13)+s->dpt[3][1]*
 (FM75_18*C7+FM75_38*S7)+s->dpt[3][2]*(FM95_110*C9+FM95_310*S9)+s->dpt[3][3]*(FM115_112*C11+FM115_312*S11)+s->dpt[3][4]*(
 FM135_114*C13+FM135_314*S13))+S6*(s->In[1][6]*S6+CM115_112*C11+CM115_312*S11+CM135_114*C13+CM135_314*S13+CM75_18*C7+CM75_38*
 S7+CM95_110*C9+CM95_310*S9-FB210_5*s->dpt[3][2]-FB212_5*s->dpt[3][3]-FB214_5*s->dpt[3][4]-FB28_5*s->dpt[3][1]-s->dpt[2][1]*(
 FM75_18*S7-FM75_38*C7)-s->dpt[2][2]*(FM95_110*S9-FM95_310*C9)-s->dpt[2][3]*(FM115_112*S11-FM115_312*C11)-s->dpt[2][4]*(
 FM135_114*S13-FM135_314*C13));
  ...
  FM42_35 = C5*(s->m[6]*AlM35_2-FM112_112*S11+FM112_312*C11-FM132_114*S13+FM132_314*C13-FM72_18*S7+FM72_38*C7-FM92_110*
 S9+FM92_310*C9)-S5*(FM16_2*C6-FM26_2*S6);
  ...
  FM33_34 = C4*(C5*(s->m[6]*AlM35_3-FM113_112*S11+FM113_312*C11-FM133_114*S13+FM133_314*C13-FM73_18*S7+FM73_38*C7-
 FM93_110*S9+FM93_310*C9)-S5*(FM16_3*C6-FM26_3*S6))+S4*(FM16_3*S6+FM26_3*C6);
